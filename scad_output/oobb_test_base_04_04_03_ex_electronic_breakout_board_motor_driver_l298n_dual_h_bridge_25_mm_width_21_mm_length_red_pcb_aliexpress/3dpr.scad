		...
		translate(v = [60, 0, 6]) {
			rotate(a = [180, 0, 0]) {
				difference() {
					...
					union() {
						translate(v = [-10.2500000000, 2.2500000000, 0]) {
							rotate(a = [0, 180, 0]) {
								difference() {
									union() {
						...
						#translate(v = [5.4850000000, -11.2850000000, 0]) {
							cube(size = [3, 12, 7]);
						}
						#translate(v = [-8.4850000000, -11.2850000000, 0]) {
							cube(size = [3, 12, 7]);
						}
						#translate(v = [-2.5000000000, -11.2500000000, 3]) {
							cube(size = [5, 12, 7]);
						}
						#translate(v = [-12.7300000000, 4.9600000000, 0]) {
							cube(size = [3, 6, 3]);
						}
					}
				}
